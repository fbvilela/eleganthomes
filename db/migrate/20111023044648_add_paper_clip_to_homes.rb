class AddPaperClipToHomes < ActiveRecord::Migration
  def self.up
     add_column :homes, :image_file_name,    :string
     add_column :homes, :image_content_type, :string
     add_column :homes, :image_file_size,    :integer
     add_column :homes, :image_updated_at,   :datetime
   end
